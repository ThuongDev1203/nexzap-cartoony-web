      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/games" className="text-gray-400 hover:text-orange-400 transition-colors">
                  {t("nav.games")}
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            <Link to="/privacy" className="text-gray-400 text-sm hover:text-orange-400 transition-colors">
              {t("footer.privacy")}
            </Link>
            <Link to="/terms" className="text-gray-400 text-sm hover:text-orange-400 transition-colors">
              {t("footer.terms")}
            </Link>
          </div>
        </div>
